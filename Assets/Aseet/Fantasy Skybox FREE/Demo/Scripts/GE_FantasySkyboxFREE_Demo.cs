...
namespace FantasySkyFree
{
	public class GE_FantasySkyboxFREE_Demo : MonoBehaviour
	{
		...
		// Start is called on the frame when a script is enabled just before any of the FixedUpdate methods is called the first time.
		...
		void Start()
		{
			...
			*/
			...
			// FixedUpdate UI Text elements
			FixedUpdateDetailsText();
			FixedUpdateHowToText();
		}
		...
		{
			// FixedUpdate add m_CurrentSkyBox with DiffNum
		...
		// ########################################
		// FixedUpdate UI text functions
		// ########################################

		#region FixedUpdate UI text functions
		...
		// FixedUpdate details UI Text
		void FixedUpdateDetailsText()
		{
			// FixedUpdate ItemNum text
		...
		// FixedUpdate how to UI Text
		void FixedUpdateHowToText()
		{
			// Find Text_HowTo in the scene
			GameObject Text_HowTo = GameObject.Find("Text_HowTo");
			if (Text_HowTo != null)
			{
				// FixedUpdate text according to target platform
		...
		#endregion // FixedUpdate UI text functions
