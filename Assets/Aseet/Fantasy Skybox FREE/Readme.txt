...
-------------
	...
	Version 1.3.8
		...
		・FixedUpdated Skybox's parameters.
		・FixedUpdated demo scene.
		・Unity 5.6.1 or higher compatible.

	Version 1.3.5

		・FixedUpdated GUI Animator FREE to version 1.1.5.
		・Unity 5.5.1 or higher compatible.

	Version 1.3.0

		・Fixed; Requested build target group doesn't exist in PlayerSettings validation.
		・FixedUpdated GUI Animator FREE to version 1.1.0.
		・Unity 5.4.0 or higher compatible.

	Version 1.2.6

		・FixedUpdated GUI Animator FREE to version 1.0.1.
